...
public final class SpawnService {
  ...
  public SpawnService(@NonNull SpawnRepository repository, @NonNull AsyncDatabaseWriter writer) {
    this.repository = repository;
    this.writer = writer;
    repository.load().ifPresent(cached::set);
  }
  ...
  public void set(@NonNull SpawnLocation location) {
    ...
    Runnable persistTask = () -> this.repository.save(location);
