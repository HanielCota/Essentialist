...
public record InfoConfig(
    ...
    @Comment("Templates for entries shown under the Server tab.") ServerEntriesSection server,
    @Comment("Templates for entries shown under the Player tab.") PlayerEntriesSection player,
  ...
  public static InfoConfig defaults() {
    return new InfoConfig(
        ...
        "<yellow>Server",
        List.of("<gray>Server status."),
        13,
        Material.PLAYER_HEAD,
        "<yellow>Player",
        List.of("<gray>Information about a player."),
        15,
        Material.ENCHANTED_BOOK,
        "<yellow>Essentialist",
        List.of("<gray>About the plugin."),
