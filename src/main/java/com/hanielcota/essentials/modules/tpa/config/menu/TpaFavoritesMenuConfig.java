...
public record TpaFavoritesMenuConfig(
  ...
  public static TpaFavoritesMenuConfig defaults() {
    return new TpaFavoritesMenuConfig(
        ...
        "{player} ({status})",
        List.of(
            "Atalho rápido para teleportar com este jogador.",
            "",
        ...
        List.of(
            ...
            "",
            "Use o botão verde para salvar seu primeiro jogador."),
        47,
        Material.EMERALD,
        "",
        "Adicionar favorito",
        List.of("Clique e digite o nick do jogador no chat.", "", "Digite cancelar para abortar."),
        49,
        Material.HOPPER,
        "Ordenar: {state}",
        List.of("Define como sua lista é mostrada.", "", "{options}", "", "Clique para mudar."),
        "Nome",
        "Recente",
        "Online primeiro",
        " ◀",
        ...
        "Sugestão: {player}",
        List.of(
            "Status: {status}", "Vocês já teleportaram {count}x.", "", "Clique para favoritar."),
        51,
        Material.ARROW,
        "Voltar",
