...
public record TpaPickPlayerMenuConfig(
  ...
  public static TpaPickPlayerMenuConfig defaults() {
    return new TpaPickPlayerMenuConfig(
        ...
        "",
        "{player}",
        List.of("Click to open the TPA actions with this player."),
        Material.BARRIER,
        "Nobody online",
        List.of("There are no other players connected right now."),
        49,
        Material.ARROW,
        "Back",
        ...
        "Filter: {filter}",
        List.of(
            "Filters the list of players shown in the menu.",
            "",
            "{options}",
            "",
            "Click to cycle the filter."),
        "All",
        "Favorites",
        "Same world",
        "Recent",
