...
public record TpaHelpMenuConfig(
  ...
  public static TpaHelpMenuConfig defaults() {
    return new TpaHelpMenuConfig(
        ...
        "",
        "{player}",
        List.of("Your teleport statistics.", "", "Click to open."),
        "—",
        19,
        Material.BOOK,
        "",
        "How it works",
        List.of(
            "Commands, examples and frequently asked questions about the teleport system.",
            "",
            "Click to open."),
        21,
        Material.BELL,
        "",
        "Incoming requests",
        List.of("You have {pending} request(s) waiting for your reply.", "", "Click to view."),
        23,
        Material.CLOCK,
        "",
        "History",
        List.of("See your latest teleports.", "", "Click to open."),
        25,
        Material.REDSTONE,
        "",
        "Settings",
        List.of(
            "Adjust your preferences: who can summon you, sounds, auto-accept favorites"
                + " and more.",
            "",
            "Click to adjust."),
        28,
        ...
        "",
        "Favorites",
        List.of("Your favorite players.", "You have {favorites} saved.", "", "Click to open."),
        32,
        Material.PLAYER_HEAD,
        true,
        "",
        "Request sent",
        List.of(
            "You asked to {type} {target}.", "", "Expires in {seconds}s.", "", "Click to cancel."),
        "go to",
        "summon",
        Material.LIGHT_GRAY_DYE,
        "No open request",
        List.of("You don't have any TPA awaiting a reply right now."),
        "yes",
        "no");
  }
}
