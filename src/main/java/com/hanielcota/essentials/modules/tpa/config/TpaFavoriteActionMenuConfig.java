  ...
  public static TpaFavoriteActionMenuConfig defaults() {
    return new TpaFavoriteActionMenuConfig(
        ...
        List.of(
            ...
            "<gray>se teleportar até você.",
            "",
            "<yellow>Clique para enviar."),
        15,
        Material.REDSTONE,
        "<red>Remover favorito",
        List.of(
            "<gray>Remove <gold>{player}</gold>",
            "<gray>da sua lista de favoritos.",
            "",
