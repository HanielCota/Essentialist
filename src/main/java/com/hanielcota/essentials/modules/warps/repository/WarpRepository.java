...
public final class WarpRepository {
  ...
  public Optional<Warp> find(@NonNull String name) {
    var rows = this.sqlExecutor.query(WarpTable.SELECT_ONE, WarpRepository::readRow, name);
  ...
  public List<Warp> list() {
    return this.sqlExecutor.query(WarpTable.SELECT_ALL, WarpRepository::readRow);
  }
