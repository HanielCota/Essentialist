...
public record HomesMainMenuConfig(
  ...
  public static HomesMainMenuConfig defaults() {
    return new HomesMainMenuConfig(
        ...
        "<green>+ New home",
        List.of(
            "<gray>Creates a home at your",
            "<gray>current position.",
            "",
            "<yellow>Click and type the name in chat."),
        8,
        Material.HOPPER,
        "<gold>Sort: <yellow>{state}",
        List.of(
            "<gray>Sorts your homes in the list.", "", "{options}", "", "<yellow>Click to cycle."),
        "Alphabetical",
        "Most used",
        "Recent",
        " <green>◀",
        List.of(
            "", "<dark_gray>Teleports: <gray>{count}", "<dark_gray>Last used: <gray>{last_used}"),
        "never",
        "<gold>★ ");
  }
